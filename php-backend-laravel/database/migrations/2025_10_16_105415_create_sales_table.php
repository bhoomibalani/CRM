...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sales', function (Blueprint $table) {
            ...
            $table->string('visit_photo')->nullable(); // File path or URL
            $table->text('remarks')->nullable();
            $table->unsignedBigInteger('sales_person_id'); // User ID of sales person
            $table->unsignedBigInteger('order_id')->nullable(); // Reference to order if new_order is true
